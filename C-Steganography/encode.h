...
typedef struct _EncodeInfo
{
    ...
    uint image_capacity;
    uint bits_per_pixel;
    char image_data[MAX_IMAGE_BUF_SIZE];    //8 byte buffer for source image data during the encoding of a byte
    ...
    /* size of the remaining data to copy from source image to sego image*/
...
/* function to check capacity of the source.bmp file*/
