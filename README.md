1. Addressbook project : It is a command line tool to manage the contact list efficiently. The key features of the address book includes creating, editing, searching, listing and deletion of contacts.

2. Steganography : LSb steganography is the method of hiding a secret file within an image by replacing the "least significant bit" of each pixel's color value with a bit from the data inside secret file. 
